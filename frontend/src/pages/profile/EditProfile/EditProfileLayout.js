      ...
      <div className="blur place_detail_information">
        <div className="container_wrapper" style={{ backgroundColor: "white" }}>
          ...
          <div className="close_button hover_style_2">
            <CIcon
              icon={cilX}
              className="icon_size_22 close_button_icon"
              onClick={() => {
                setVisible(false);
              }}
            />
          ...
          <div className="settings_layout hidden">
            <div className="settings_header">
              ...
              <p className="settings_description">
                Keep your profile fresh and personalized! Edit your details
                below to make sure everything is accurate and up to date.
              </p>
            </div>
