...
export default function DiscoverPostList() {
        ...
        <Box sx={{ width: '100%'}}>
            <Masonry columns={{ xs: 1, sm: 2, md: 3 }} spacing={2}>
                {currentItems.map((item, index) => (
                    <Post key={index} className='discover_post'>
                        {item.img && (
                            <Box
                                component="img"
...
const users = [
    { name: 'Emily', avatar: 'https://randomuser.me/api/portraits/women/44.jpg' },
...
const itemData = [
    ...
    {
        title: 'Post 3',
        content: 'Nothing beats the classic combo of Roti Canai and Teh Tarik for breakfast! Crisp on the outside, fluffy on the inside. And the Teh Tarik? Perfectly sweet and frothy.',
        img: 'https://res.cloudinary.com/dgcctevjo/image/upload/v1723995140/abcdedfr/post_medias/v6jwfwwn82zzt67ojixp.jpg',
        user: users[2]
    },
    {
        title: 'Post 4',
