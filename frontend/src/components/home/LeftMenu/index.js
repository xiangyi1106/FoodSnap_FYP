...
export default function LeftMenu({ page, setPage }) {
    ...
    return (
        <div className="left_menu">
            ...
            <Link className={`left_link ${currentPath === "/myWishlistVenue" ? "link_active" : ""}`} to="/myWishlistVenue" onClick={() => handleMenuClick("myWishlistVenue")}>
                <CIcon icon={cilPlaylistAdd} className="icon_size_20 left_link_active" />
                <span>My Wishlist Venue</span>
            </Link>
